...
process.title = "Multithread Polygon Bruteforce by Corvus Codex";
...
data.toString().split("\n").forEach(address => {
    if (address.startsWith('0x')) {
        ...
        console.error('Error: Polygon addresses are not in correct format. Addresses must start with 0x');
        process.exit(1);
    }
});
...
function generate() {
    ...
    // Generating a new random Polygon keypair
